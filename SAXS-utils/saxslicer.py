...
class SAXSlicer:
    ...
    def __init__(self, input_file: str = None):
        if input_file is None: input_file = "Jupyter/datasets/SI06_210623[7].pdh"
    ...
    def extract_data(self) -> pd.DataFrame:
        ...
        dataframe = pd.read_table(self.input_file, delimiter = "   ", usecols=[0,1], names = ["scattering_vector", "counts_per_area"], header=5, skipfooter=496, engine = "python")
        return dataframe
    ...
    def extract_metadata(self, directory_for_XML_file: str = None) -> etree.ElementTree:
        ...
        if directory_for_XML_file is None: directory_for_XML_file = "Jupyter/datasets/xml-test.xml"
