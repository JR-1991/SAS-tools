...
path_to_data = "C:/Users/Selly/Documents/Uni/INF_Project/measurement_data/OTAB/OTAB_measurement_data/plot_data_overview/"
files = [file for file in os.listdir(path_to_data) if file.endswith(".pdh")]

phase = ["$\mathrm{L}_{1}$", "$\mathrm{H}_{1}$", "cr"]
y_shift = [0, 1, 5]
...
plt.savefig("OTAB_overview_log.png")
plt.show()
